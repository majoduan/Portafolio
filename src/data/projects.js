export const projects = [
  ...
  },
  {
    ...
    description: "A remake of the classic Space Invaders game. It features player movement, shooting mechanics, destructible obstacles, multiple alien rows with varying scores, bonus enemies, and a main menu with a scoring system.",
    tech: ["Python", "Pygame"],
