...
export const getTechnologies = (t) => ({
  ...
  databases: [
    ...
    { name: t('technologies.skills.mysql.name'), description: t('technologies.skills.mysql.description'), level: 75, experience: "3+ years", icon: MySQLIcon, color: "from-blue-900 to-blue-1000", tagColor: "from-blue-700 to-blue-700" },
    ...
    { name: t('technologies.skills.oracle.name'), description: t('technologies.skills.oracle.description'), level: 75, experience: "1+ years", icon: OracleIcon, color: "from-slate-100 to-slate-300", tagColor: "from-red-600 to-red-600" },
  ...
  devops: [
    ...
    { name: t('technologies.skills.vercel.name'), description: t('technologies.skills.vercel.description'), level: 80, experience: "2+ years", icon: VercelIcon, color: "from-slate-100 to-slate-300", tagColor: "from-gray-700 to-gray-700" },
    ...
    { name: t('technologies.skills.aws.name'), description: t('technologies.skills.aws.description'), level: 40, experience: "1/2 years", icon: AWSIcon, color: "from-orange-300 to-yellow-400", tagColor: "from-amber-500 to-amber-500" },
    ...
    { name: t('technologies.skills.unity.name'), description: t('technologies.skills.unity.description'), level: 40, experience: "1/2 years", icon: UnityIcon, color: "from-gray-600 to-gray-800", tagColor: "from-gray-600 to-gray-600" }
  ]
});
