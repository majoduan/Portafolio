...
export const certificates = [
  { title: "EPN Academic Excellence Award", org: "Escuela Politécnica Nacional", icon: "🏆", slug: "epn-award" },
  { title: "Networking Basics", org: "Cisco Networking Academy", icon: "🌐", slug: "cisco-networking" },
  { title: "Digital Transformation", org: "Instituto Europeo de Posgrado", icon: "🚀", slug: "digital-transformation" },
  { title: "SCRUM Foundation", org: "Certiprof - SFPC™", icon: "⚡", slug: "scrum-foundation" }
];
